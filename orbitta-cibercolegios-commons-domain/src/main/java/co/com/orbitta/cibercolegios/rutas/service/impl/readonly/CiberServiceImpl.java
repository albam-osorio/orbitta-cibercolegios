...
public class CiberServiceImpl implements CiberService {
	...
	@Override
	public List<UsuarioDto> findAllPajaserosSinRutaByGrado(int institucionId, int jornadaId, int nivelId, int programaId,
			int gradoId) {
		// @formatter:off
		val sql = "" +
				"SELECT \r\n" + 
	...
	public Optional<UsuarioPerfilDto> findPerfilByUsuario(int usuarioId) {
		val sql = "SELECT ID_USUARIO, b.DESCRIPCION AS TIPO_DOCUMENTO, FOTO, TEL_CASA, DIR_CASA, EMAIL FROM CIBER.USUARIOS a INNER JOIN CIBER.TIPO_ID b ON b.ID_TIPOID = a.ID_TIPOID  WHERE a.ID_USUARIO = :ID_USUARIO";
