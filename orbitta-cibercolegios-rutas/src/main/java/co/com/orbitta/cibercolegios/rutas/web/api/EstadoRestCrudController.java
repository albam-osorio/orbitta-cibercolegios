...
@RestController
@RequestMapping(value = RutasRestConstants.estado, produces = MediaType.APPLICATION_JSON_VALUE)
public class EstadoRestCrudController extends RestCrudController<EstadoRutaDto, Integer> {
