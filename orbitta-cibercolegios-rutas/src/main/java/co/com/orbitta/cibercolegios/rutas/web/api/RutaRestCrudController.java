...
@RestController
@RequestMapping(value = RestConstants.ruta, produces = MediaType.APPLICATION_JSON_VALUE)
public class RutaRestCrudController extends RestCrudController<RutaDto, RutaDto, Integer> {
