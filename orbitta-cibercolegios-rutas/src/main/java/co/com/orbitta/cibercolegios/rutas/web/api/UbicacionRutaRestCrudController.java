...
@RestController
@RequestMapping(value = RutasRestConstants.ubicacionRuta, produces = MediaType.APPLICATION_JSON_VALUE)
public class UbicacionRutaRestCrudController extends RestCrudController<LogRutaDto, Integer> {
