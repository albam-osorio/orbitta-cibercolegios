...
@RestController
@RequestMapping(value = RutasRestConstants.mensajeRuta, produces = MediaType.APPLICATION_JSON_VALUE)
public class MensajeRutaRestCrudController extends RestCrudController<MensajeRutaDto, Integer> {
