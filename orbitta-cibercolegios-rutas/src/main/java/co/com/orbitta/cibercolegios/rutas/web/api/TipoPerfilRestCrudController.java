...
@RestController
@RequestMapping(value = RutasRestConstants.tipoPerfil, produces = MediaType.APPLICATION_JSON_VALUE)
public class TipoPerfilRestCrudController extends RestCrudController<TipoPerfilDto, Integer> {
