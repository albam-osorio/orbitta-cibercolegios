...
@RestController
@RequestMapping(value = RestConstants.institucion, produces = MediaType.APPLICATION_JSON_VALUE)
public class InsitucionRestCrudController extends RestCrudController<InstitucionDto, InstitucionDto, Integer> {
