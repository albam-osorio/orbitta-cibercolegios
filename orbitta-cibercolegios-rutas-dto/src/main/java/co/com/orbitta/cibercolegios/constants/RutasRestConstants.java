...
public class RutasRestConstants {
	...
	final public static String conversacion = base + "/conversacion";

	final public static String estadoPasajero = base + "/estado-usuario-ruta";
	...
	final public static String mensaje = base + "/mensaje";
